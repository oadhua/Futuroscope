...
if __name__ == "__main__":
    df_raw = pd.read_csv(r"D:\Stage SI\Machine Learning\Futuroscope\windows\donne_clean\master_outliers\H03_thermal_outliers.csv")
    ...
    df_ml.to_csv(r"D:\Stage SI\Machine Learning\Futuroscope\windows\donne_clean\master_ml\master_H03_predict_pure_thermal.csv", index=False)
