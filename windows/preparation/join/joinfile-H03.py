...
df_master = df_master.merge(
    df_horaire[["date_pure", "is_weekend", "is_open", "type_frequentation"]],
    on="date_pure",
    how="left",
)
...
output_path = "D:\\Stage SI\\Machine Learning\\Futuroscope\\windows\\donne_clean\\master\\master_H03.csv"
