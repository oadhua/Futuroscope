...
# ==============================================================================
# 1. CHARGEMENT DU MASTER FILE BRUT CONSOLIDÉ (THERMAL)
# ==============================================================================
...
# ==============================================================================
ordre_colonnes = [
    'date', 'visitor_count', 'frequentation', 'ec_value',
...
# ------------------------------------------------------------------------------
print("=" * 65)
print("2. BÁO CÁO DỮ LIỆU CÒN THIẾU SAU KHI XỬ LÝ (THERMAL - AFTER CLEANING)")
print("=" * 65)
...
# Sau đó tiến hành xuất file CSV
output_clean_path = r"D:\Stage SI\Machine Learning\Futuroscope\windows\donne_clean\master_missing\master_H03_thermal_missing.csv"
df_master_clean.to_csv(output_clean_path, index=False)

print(f"Master File Nhiệt nettoyé avec succès ! Lignes : {len(df_master_clean)}")
