...
class ColumnProfileSchema(BaseModel):
    ...
    column_type: str = Field(..., description="Kiểu dữ liệu chuẩn hóa (Integer, Float, Date, String...)")
    raw_data_type: str = Field(..., description="Kiểu dữ liệu gốc từ database/data frame")
