...
router = APIRouter(
    prefix="/initial-profiling",
    tags=["Initial Profiling"]
)
...
def get_versions():
    """Lấy danh sách các phiên bản dữ liệu hiện có."""
...
def get_initial_profiling(
    ...
    id_attraction: Optional[str] = Query(None, description="Lọc theo mã trò chơi (ví dụ: H01, H03, ALL)"),
