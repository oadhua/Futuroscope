...
# ==========================================================
# 4. Normalisation des données (Standard Scaling pour ANN)
# ==========================================================
# Une mise à l'échelle standardisée (moyenne=0, écart-type=1) est cruciale pour les réseaux de neurones
...
# ==========================================================
# 5. Construction et entraînement du modèle ANN (Multi-output)
# ==========================================================
model = Sequential()
...
print("--- DEBUT DE L'ENTRAINEMENT DE L'ANN GLOBAL ---")
history = model.fit(
    X_train_scaled, 
    y_train_scaled,
    epochs=100,
...
print("\n=== RÉSULTATS DU MODÈLE GLOBAL ANN - MULTI-OUTPUT ===")
...
titre_graphe = f"Prévisions Globales (elec_1 & elec_2) via ANN | elec_1_R²: {r2_chi_tiet[0]:.4f} - MAE: {mae_chi_tiet[0]:.2f} | elec_2_R²: {r2_chi_tiet[1]:.4f} - MAE: {mae_chi_tiet[1]:.2f}"
fig.update_layout(
    title=titre_graphe,
    xaxis_title="Date",
...
fig.write_html("prévisions_ann_elec.html")
