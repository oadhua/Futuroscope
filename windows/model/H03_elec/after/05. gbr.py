...
# ---------------------------------------------------------
# 4. EXPLICABILITÉ XAI AVEC SHAP (BAR PLOT - TOÀN BỘ FEATURES)
# ---------------------------------------------------------
print("\n---------------------------------------------------------")
print("--- ANALYSE D'EXPLICABILITÉ APPROFONDIE (SHAP VALUES) ---")
...
X2_test_renamed = X2_test.rename(columns=feature_rename_map)

# ------------------- VẼ SHAP CHO ELEC_1 -------------------
explainer_1 = shap.TreeExplainer(model_elec_1)
shap_values_1 = explainer_1(X1_test_renamed)

fig, ax = plt.subplots(figsize=(12, 10))

# Vẽ Bar Plot với màu mặc định của SHAP cho TOÀN BỘ 29 biến
shap.plots.bar(
    shap_values_1,
...
plt.title("SHAP Feature Importances - elec_1", fontsize=16, pad=15, color="#333333")

# Ẩn đường viền khung hình (spines) cho thoáng mắt
for spine in ["top", "right", "left"]:
    ax.spines[spine].set_visible(False)

plt.tight_layout()
shap_img_1 = "shap_feature_importances_elec_1.png"
plt.savefig(shap_img_1, dpi=300, bbox_inches="tight")
plt.close()


# ------------------- VẼ SHAP CHO ELEC_2 -------------------
explainer_2 = shap.TreeExplainer(model_elec_2)
shap_values_2 = explainer_2(X2_test_renamed)

fig, ax = plt.subplots(figsize=(12, 10))

shap.plots.bar(
    shap_values_2,
    max_display=len(X2_test_renamed.columns),
    show=False,
)

plt.title("SHAP Feature Importances - elec_2", fontsize=16, pad=15, color="#333333")

for spine in ["top", "right", "left"]:
    ax.spines[spine].set_visible(False)

plt.tight_layout()
shap_img_2 = "shap_feature_importances_elec_2.png"
plt.savefig(shap_img_2, dpi=300, bbox_inches="tight")
plt.close()

print(
    f"\n[OK] Biểu đồ SHAP Bar Plot (29 biến) đã lưu thành công: {shap_img_1} | {shap_img_2}"
)
print("=========================================================\n")
