...
class OptimiseurConsoThermique:
    ...
    Applicable au bâtiment H03 (Tapis Magique) et au Pavillon de la Vienne.
    ...
    """
    def __init__(self, site="tapis", ec_standby=2.0):
...
if __name__ == "__main__":
    ...
    if os.path.exists(input_file):
        ...
        excel_path = "Planning_Optimisation_EC_H03.xlsx"
        csv_path = "Planning_Optimisation_EC_H03.csv"
