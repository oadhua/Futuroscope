...
print("\n--- KẾT QUẢ: INDEPENDENT GRADIENT BOOSTING REGRESSOR ---")
...
# ---------------------------------------------------------
# Tạo chuỗi subtitle với định dạng phông chữ gọn gàng
...
fig = make_subplots(
    ...
    cols=1,
    shared_xaxes=True,
    vertical_spacing=0.18,  # Tăng khoảng cách đứng giữa 2 biểu đồ để tránh đè chữ
...
# Cấu hình lại layout và phông chữ các tiêu đề con
fig.update_layout(
    height=850,  # Tăng chiều cao tổng thể
    margin=dict(t=100, b=60, l=60, r=40),  # Tạo lề thoáng hơn
...
# Tinh chỉnh phông chữ tiêu đề con để không lấn chiếm không gian
