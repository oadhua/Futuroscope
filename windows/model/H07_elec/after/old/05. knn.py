...
# ==========================================================
# 4. Entraînement du modèle k-NN (Multi-output)
# ==========================================================
# Un StandardScaler est indispensable pour que le calcul des distances de k-NN soit correct
...
modele = MultiOutputRegressor(base_knn)
...
print("=== RÉSULTATS DU MODÈLE GLOBAL k-NN - MULTI-OUTPUT ===")
print(f"k-NN Train R² (Moyenne): {r2_train:.4f}")
print(f"k-NN Test R²  (Moyenne): {r2_global:.4f} | MAE (Moyenne): {mae_global:.2f}")
print("-" * 65)
...
titre_graphe = f"Prévisions Globales (elec_1 & elec_2 & elec_3) via KNN | elec_1_R²: {r2_chi_tiet[0]:.4f} - MAE: {mae_chi_tiet[0]:.2f} | elec_2_R²: {r2_chi_tiet[1]:.4f} - MAE: {mae_chi_tiet[1]:.2f} | elec_3_R²: {r2_chi_tiet[2]:.4f} - MAE: {mae_chi_tiet[2]:.2f}"
fig.update_layout(
    title=titre_graphe,
    xaxis_title="Date",
...
fig.write_html("prévisions_knn_elec.html")
