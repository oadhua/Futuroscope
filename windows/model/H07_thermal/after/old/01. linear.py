...
# Utilisation de MultiOutputRegressor pour prédire elec_1, elec_2 et elec_3 simultanément
...
titre_graphe = f"Prévisions Globales (elec_1 & elec_2 & elec_3) via MLR | elec_1_R²: {r2_chi_tiet[0]:.4f} - MAE: {mae_chi_tiet[0]:.2f} | elec_2_R²: {r2_chi_tiet[1]:.4f} - MAE: {mae_chi_tiet[1]:.2f} | elec_3_R²: {r2_chi_tiet[2]:.4f} - MAE: {mae_chi_tiet[2]:.2f}"
fig.update_layout(
    title=titre_graphe,
    xaxis_title="Date",
