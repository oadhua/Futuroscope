...
print("\n==========================================================")
print(f"MLR Train R²: {r2_train:.4f}")
print(f"MLR Test R²: {r2:.4f} | MAE: {mae:.2f} | MSE: {mse:.2f}")
print("==========================================================")
...
titre_graphe = (
    f"Prévisions ec_value MLR | R²: {r2:.4f} | MAE: {mae:.2f}"
)
fig.update_layout(
    title=titre_graphe,
    xaxis_title="Date",
...
fig.write_html("prévisions_mlr.html")
