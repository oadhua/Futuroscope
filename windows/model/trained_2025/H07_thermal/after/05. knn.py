...
# ==========================================================
# 4. Normalisation des données (Crucial cho KNN)
# ==========================================================
...
# ==========================================================
# n_neighbors=5 (mặc định), weights='distance' giúp các điểm gần hơn có trọng số cao hơn
modele = KNeighborsRegressor(n_neighbors=5, weights='distance', n_jobs=-1)
...
print("\n==========================================================")
print(f"KNN Train R²: {r2_train:.4f}")
print(f"KNN Test R²: {r2:.4f} | MAE: {mae:.2f} | MSE: {mse:.2f}")
print("==========================================================")
...
titre_graphe = (
    f"Prévisions ec_value KNN | R²: {r2:.4f} | MAE: {mae:.2f}"
)
fig.update_layout(
    title=titre_graphe,
    xaxis_title="Date",
...
fig.write_html("prévisions_knn.html")
