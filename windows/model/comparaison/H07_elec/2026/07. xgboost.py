...
subtitles = (
    f"<b>elec_1 : Consommation Réelle vs Modèle XGBoost</b><br><span style='font-size: 11px; color: #555;'>RMSE: {r1:.2f} kWh | MAE: {m1:.2f} kWh | R²: {r2_1:.4f}</span>",
    f"<b>elec_2 : Consommation Réelle vs Modèle XGBoost</b><br><span style='font-size: 11px; color: #555;'>RMSE: {r2:.2f} kWh | MAE: {m2:.2f} kWh | R²: {r2_2:.4f}</span>"
)
...
fig_graph.update_layout(
    ...
    title=dict(
        text="<b>ÉVALUATION GRAPHIQUE DES PRÉDICTIONS (2026)</b>",
        x=0.5,
...
fig_kpi.update_layout(
    title_text="<b>BILAN GLOBAL ANNUEL DE CONSOMMATION (2026)</b>",
    title_x=0.5,
    height=350,
...
<head>
    ...
    <title>Rapport Comparatif Énergétique 2026</title>
    <style>
        body {{
...
output_combined_html = "dashboard_elec_2026_xgboost.html"
