...
subtitle_1 = f"<b>ec_value : Consommation Thermique Réelle vs Modèle XGBoost</b><br><span style='font-size: 11px; color: #555;'>RMSE: {r1:.2f} | MAE: {m1:.2f} | R²: {r2_1:.4f}</span>"
...
fig_graph.update_layout(
    ...
    title=dict(
        text="<b>ÉVALUATION GRAPHIQUE DE LA PRÉVISION THERMIQUE (2025)</b>",
        x=0.5,
...
fig_kpi.update_layout(
    title_text="<b>BILAN GLOBAL ANNUEL : EC_VALUE (2025)</b>",
    title_x=0.5,
    height=300,
...
<head>
    ...
    <title>Rapport Prédiction Thermique 2025 - Random Forest</title>
    <style>
        body {{
...
output_combined_html = "dashboard_thermal_2025_xgboost.html"
